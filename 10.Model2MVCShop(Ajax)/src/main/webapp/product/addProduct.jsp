	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			...
			<td class="ct_write01">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="105" id="prodName">${product.prodName}</td>
						<td></td>
					</tr>
				</table>
			</td>
		...
		<tr>
			...
			<td bgcolor="D6D6D6" width="1"></td>
			<td class="ct_write01" id="prodDetail">${product.prodDetail}</td>
		</tr>
		<tr>
			<td height="1" colspan="3" bgcolor="D6D6D6"></td>
		</tr>
		...
		<tr>
			...
			<td bgcolor="D6D6D6" width="1"></td>
			<td class="ct_write01" id="manuDate">${product.manuDate}</td>
		</tr>
		<tr>
			<td height="1" colspan="3" bgcolor="D6D6D6"></td>
		</tr>
		<tr>
			...
			<td bgcolor="D6D6D6" width="1"></td>
			<td class="ct_write01" id="price">${product.price}</td>
		</tr>
